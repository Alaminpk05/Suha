                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(image: AssetImage('assets/5.jpg',),fit: BoxFit.cover)
                    ),
                    height: 18.h,
                    width: 94.w,
                  ),
                  Align(
                    ...
                    child: PagesTitleText(title: 'Sub Category', 
                  ...
                  const CategorySection2(),
                   Align(
                    alignment: Alignment.topLeft,
                    child: PagesTitleText(title: 'Products', 
                    fontsize:16.sp ,fontWeight: FontWeight.w700, color: Colors.white,),
                  ),
               GridViewWidget(mobile: mobile,tablet: tablet,scrollPhysics: NeverScrollableScrollPhysics(),)
