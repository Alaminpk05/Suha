...
class CycloneOfferWidget extends StatelessWidget {
  ...
  const CycloneOfferWidget({
    super.key,
    required this.value, required this.asset, required this.title,
  });
  final String? asset;
  final String? title;
  final double value;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          padding: EdgeInsets.only(left: 1.9.w,right: 1.9.w,bottom: 2.h,top: 1.5.h),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              Center(child: Image.asset(asset!,width: 22.w,)),
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                        children: [
                          Text("\$7.99",style: TextStyle(color: Colors.white,
                              fontSize: 16.sp,fontWeight: FontWeight.w700),
                            overflow: TextOverflow.ellipsis,),
                          SizedBox(width: 1.w),
                          Center(
